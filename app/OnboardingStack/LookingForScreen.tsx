...
import { GenderInterest } from 'constants/enum';
...
const OPTIONS: { value: GenderInterest; label: string }[] = [
  { value: GenderInterest.Male, label: 'Male' },
  { value: GenderInterest.Female, label: 'Female' },
  { value: GenderInterest.Everyone, label: 'Everyone' },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <FadeInView style={styles.content}>
        <AppText style={styles.title}>Who are you interested in?</AppText>
